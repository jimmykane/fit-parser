...
export type ActivityClass = 'level_max' | 'level' | 'athlete'
...
export type AttitudeValidity = 'track_angle_heading_valid' | 'pitch_valid' | 'roll_valid' | 'lateral_body_accel_valid' | 'normal_body_accel_valid' | 'turn_rate_valid' | 'hw_fail' | 'mag_invalid' | 'no_gps' | 'gps_invalid' | 'solution_coasting' | 'true_track_angle' | 'magnetic_heading'
...
export type BatteryStatus = 'new' | 'good' | 'ok' | 'low' | 'critical' | 'charging' | 'unknown'
...
export type CameraOrientationType = 'camera_orientation0' | 'camera_orientation90' | 'camera_orientation180' | 'camera_orientation270'
...
export type CourseCapabilities = 'processed' | 'valid' | 'time' | 'distance' | 'position' | 'heart_rate' | 'power' | 'cadence' | 'training' | 'navigation' | 'bikeway' | 'aviation'
...
export type FileFlags = 'read' | 'write' | 'erase'
...
export type LanguageBits0 = 'english' | 'french' | 'italian' | 'german' | 'spanish' | 'croatian' | 'czech' | 'danish'
export type LanguageBits1 = 'dutch' | 'finnish' | 'greek' | 'hungarian' | 'norwegian' | 'polish' | 'portuguese' | 'slovakian'
export type LanguageBits2 = 'slovenian' | 'swedish' | 'russian' | 'turkish' | 'latvian' | 'ukrainian' | 'arabic' | 'farsi'
export type LanguageBits3 = 'bulgarian' | 'romanian' | 'chinese' | 'japanese' | 'korean' | 'taiwanese' | 'thai' | 'hebrew'
export type LanguageBits4 = 'brazilian_portuguese' | 'indonesian' | 'malaysian' | 'vietnamese' | 'burmese' | 'mongolian'
...
export type LeftRightBalance = 'mask' | 'right'
export type LeftRightBalance100 = 'mask' | 'right'
...
export type NoFlyTimeMode = 'standard' | 'flat24_hours'
...
export type SportBits0 = 'generic' | 'running' | 'cycling' | 'transition' | 'fitness_equipment' | 'swimming' | 'basketball' | 'soccer'
export type SportBits1 = 'tennis' | 'american_football' | 'training' | 'walking' | 'cross_country_skiing' | 'alpine_skiing' | 'snowboarding' | 'rowing'
export type SportBits2 = 'mountaineering' | 'hiking' | 'multisport' | 'paddling' | 'flying' | 'e_biking' | 'motorcycling' | 'boating'
export type SportBits3 = 'driving' | 'golf' | 'hang_gliding' | 'horseback_riding' | 'hunting' | 'fishing' | 'inline_skating' | 'rock_climbing'
export type SportBits4 = 'sailing' | 'ice_skating' | 'sky_diving' | 'snowshoeing' | 'snowmobiling' | 'stand_up_paddleboarding' | 'surfing' | 'wakeboarding'
export type SportBits5 = 'water_skiing' | 'kayaking' | 'rafting' | 'windsurfing' | 'kitesurfing' | 'tactical' | 'jumpmaster' | 'boxing'
export type SportBits6 = 'floor_climbing'
...
export type SupportedExdScreenLayouts = 'full_screen' | 'half_vertical' | 'half_horizontal' | 'half_vertical_right_split' | 'half_horizontal_bottom_split' | 'full_quarter_split' | 'half_vertical_left_split' | 'half_horizontal_top_split'
...
export type TimeMode = 'hour12' | 'hour24' | 'military' | 'hour12_with_seconds' | 'hour24_with_seconds' | 'utc'
...
export type TissueModelType = 'zhl16c'
...
export type Weight = 'calculating'
...
export type WktStepTarget = 'speed' | 'heart_rate' | 'open' | 'cadence' | 'power' | 'grade' | 'resistance' | 'power3s' | 'power10s' | 'power30s' | 'power_lap' | 'swim_stroke' | 'speed_lap' | 'heart_rate_lap'
export type WorkoutCapabilities = 'interval' | 'custom' | 'fitness_equipment' | 'firstbeat' | 'new_leaf' | 'tcx' | 'speed' | 'heart_rate' | 'distance' | 'cadence' | 'power' | 'grade' | 'resistance' | 'protected'
export type WorkoutEquipment = 'none' | 'swim_fins' | 'swim_kickboard' | 'swim_paddles' | 'swim_pull_buoy' | 'swim_snorkel'
export type WorkoutHr = 'bpm_offset'
export type WorkoutPower = 'watts_offset'
