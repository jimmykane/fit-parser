/*
 * Generated from @garmin/fitsdk 21.208.0.
...
export const GARMIN_MESSAGES: Record<number, Message> = {
  0: {
    0: {
      field: 'type',
      type: 'file',
...
export const GARMIN_TYPES: Record<string, Record<number, string | number>> = {
  activity: {
    0: 'manual',
    1: 'auto_multi_sport',
  },
