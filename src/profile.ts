...
export const PROFILE_TYPES: Record<string, Record<number, string | number>> = {
  activity: {
    0: 'manual',
    1: 'auto_multi_sport',
  },
  ...
  course_point: FIT_PROFILE_COURSE_POINTS,
  ...
  garmin_product: FIT_PROFILE_GARMIN_PRODUCTS,
  ...
  manufacturer: FIT_PROFILE_MANUFACTURERS,
  max_met_category: {
    0: 'generic',
    1: 'cycling',
  },
  ...
  sub_sport: FIT_PROFILE_SUB_SPORTS,
